...
describe('ArrayUtils unit tests', function () {
    const types = [BigInt64Array, BigUint64Array, Float32Array, Float64Array, Int8Array, Int32Array, Uint8Array, Uint32Array];
    describe('#isArray()', function () {
        it('Should return false if not an array', function () {
            ...
            expect(isArray(function foo(){return [];})).to.equal(false);
        });
    ...
    describe('#isTypedArray()', function () {
        it('Should return false if not a typed array', function () {
            ...
            expect(isTypedArray(function foo(){return [];})).to.equal(false);
